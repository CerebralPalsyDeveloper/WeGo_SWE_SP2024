...
const FarmFlightPlugin = () => {
    const navigate = useNavigate();
    const payloadOptions = [
        { label: 'Crop Monitoring', price: 20, schedule: 'Monthly' },
        { label: 'Crop Spraying', price: 30, schedule: 'Bi-weekly' },
        { label: 'Soil Analysis', price: 25, schedule: 'Quarterly' }
    ];
...
export default FarmFlightPlugin;
